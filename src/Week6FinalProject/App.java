	...
	public static void main(String[] args) {
     ...
     //flip cards
        for (int i = 0; i < 26; i++) {
             ...
             System.out.println("Player 1 has the following card: " + player1Card.getName());
             System.out.println("Player 2 has the following card: " + player2Card.getName());
             //compare values
             if (player1Card.getValue() > player2Card.getValue()) {
                 player1.incrementScore();
                 System.out.println("Player 1 wins and gets a point.");
             } else if (player2Card.getValue() > player1Card.getValue()) {
                 player2.incrementScore();
                 System.out.println("Player 2 wins and gets a point.");
             } else {
